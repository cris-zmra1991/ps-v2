                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="solic_page.php">Revisar solicitudes</a>
                                    </li>
                                    <li>
                    ...
                    <div class="row">
                        <div class="col-lg-12"> 
                          <table class="table d-block m-3">
                              ...
                              $query = $conexion1->prepare('SELECT * FROM users');
                              $query->execute();
                              $data = $query->fetchAll();
                              ...
                              foreach($data as $solicitudes){ ?>
                      				<tr>
                      					...
                      					<td><a class="btn btn-warning" href="<?php echo "user_modify.php?name=" . $solicitudes["name"]?>"><i class="fa fa-edit"></i></a></td>
                      					<td><a class="btn btn-danger" href="<?php echo "user_delete.php?name=" . $solicitudes["name"]?>"><i class="fa fa-trash"></i></a></td>
                      				</tr>
                      				<?php } ?>
                      			</tbody>
                      		</table>
